...
time.sleep(2)
subprocess.call(['./cucodb.py', '--user', 'dpool', '--pw', '9982', '--name', 'Wade Wilson', 
...
time.sleep(2)
subprocess.call(['./cucodb.py', '--user', 'jrhodes', '--pw', '98233', '--name', 'James Rhodes', 
                '--email','jrhodes@clemson.edu',
                '--classes', 'CPSC 4200', 'CPSC 3220',
                '--hobbies', 'Cooking', 'Martial Arts', 'Board Games', 'Coding', 
                ])
time.sleep(2)
subprocess.call(['./cucodb.py', '--user', 'slang', '--pw', '127893', '--name', 'Scott Lang', 
